...
App::uses('GeocodeLib', 'Geography.Lib');
 ...
 * 2011-01-13 ms
*/
class GoogleGeocodeBehavior extends ModelBehavior {
    ...
    public function setup(Model $Model, $settings = array()) {
        $default = array(
                'real' => false, 'address' => array('address', 'zip', 'city', 'country'),
                'require' => false, 'allowEmpty' => true, 'invalidate' => array(), 'expect' => array(),
                'lat' => 'latitude', 'lng' => 'longitude', 'formatted_address' => 'formatted_address', 'host' => 'us', 'language' => 'en', 'region' => '', 'bounds' => '',
                'overwrite' => true, 'update' => array(), 'before' => 'save',
                'min_accuracy' => 0, 'allow_inconclusive' => true, 'unit' => GeocodeLib::UNIT_MILES,
