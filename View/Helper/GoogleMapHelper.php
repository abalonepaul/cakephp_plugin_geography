...
'navOptions' => array(),
'scaleOptions' => array(),
'defaultLat' => 38, # only last fallback, use Configure::write('Google.lat', ...); to define own one
'defaultLng' => -121, # only last fallback, use Configure::write('Google.lng', ...); to define own one
'defaultZoom' => 8,
),
'staticMap' => array(
'size' => '200x200',
...
$map .= "
window.".$this->name()." = new google.maps.Map(document.getElementById(\"".$this->_currentOptions['div']['id']."\"), myOptions);
";
$this->map = $map;
